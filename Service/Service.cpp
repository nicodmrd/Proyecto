...
//------------------------------------Encargados----------------------------------------------
int SimuladorService::Service::AgregearEncargado(Encargado^ encargado)
{
    /*
    ...
    */
    return Persistance::AgregarEncargado(encargado);
}
int SimuladorService::Service::ActualizarEncargado(Encargado^ encargado)
{
    /*
    ...
    */
    return Persistance::ActualizarEncargado(encargado);
}
int SimuladorService::Service::EliminarEncargado(int EncargadoId)
{
    /*
    for (int i = 0; i < lista_encargados->Count; i++) {
    ...
    throw gcnew DoesNotExistException("El encargado no existe en la base de datos.");
    */
    return Persistance::EliminarEncargado(EncargadoId);
}
...
//--------------------------------------------Camiones------------------------------------------
int SimuladorService::Service::AgregarCamion(Camion^ camion)
{
    /*
    ...
    */
    return Persistance::AgregarCamion(camion);
}

int SimuladorService::Service::ActualizarCamion(Camion^ camion)
{
    /*
    ...
    */
    return Persistance::ActualizarCamion(camion);
}
int SimuladorService::Service::EliminarCamion(int CamionId)
{
    /*
    for (int i = 0; i < lista_camiones->Count; i++) {
    ...
    throw gcnew DoesNotExistException("El camión ingresado no existe en la base de datos.");
    */
    return Persistance::EliminarCamion(CamionId);
}
List<Camion^>^ SimuladorService::Service::ConsultarCamion()
{
    ...
    */
    return Persistance::ConsultarCamiones();
}
Camion^ SimuladorService::Service::ConsultarCamionPorId(int CamionId)
{
    ...
    return nullptr;
    */
    return Persistance::ConsultarCamionPorId(CamionId);
}

//------------------------------------------Barcos--------------------------------------------------
int SimuladorService::Service::AgregarBarco(Barco^ barco_center) {
    /*
    ...
    */
    return Persistance::AgregarBarco(barco_center);
}
int SimuladorService::Service::ActualizarBarco(Barco^ barco_center) {
    /*
    ...
    */
    return Persistance::ActualizarBarco(barco_center);
}
int SimuladorService::Service::EliminarBarco(int barco_center) {
    /*
    for (int i = 0; i < barcoList->Count; i++) {
    ...
    */
    return Persistance::EliminarBarco(barco_center);
}
List<Barco^>^ SimuladorService::Service::ConsultarBarcos() {
    ...
    return barcoList;
    */
    return Persistance::ConsultarBarcos();
}
Barco^ SimuladorService::Service::ConsultarBarcoPorId(int barco_center) {
    ...
    return nullptr;
    */
    return Persistance::ConsultarBarcoPorId(barco_center);
}
...
//-----------------------------------------Dron--------------------------------------------------
int SimuladorService::Service::AddDron(Dron^ DronId) {
    /*
    ...
    */
    return Persistance::AgregarDron(DronId);
}

int SimuladorService::Service::UpdateDron(Dron^ DronId) {
    /*
    ...
    */
    return Persistance::ActualizarDron(DronId);
}
int SimuladorService::Service::DeleteDron(int DronId) {
    /*
    for (int i = 0; i < dronList->Count; i++) {
    ...
    throw gcnew DoesNotExistException("El dron no existe en la base de datos.");
    */
    return Persistance::EliminarDron(DronId);
}
List<Dron^>^ SimuladorService::Service::QueryDron() {
    ...
    return dronList;
    */
    return Persistance::ConsultarDron();
}
...
Dron^ SimuladorService::Service::QueryDronById(int DronId) {
    ...
    return nullptr;
    */
    return Persistance::ConsultarDronPorId(DronId);
